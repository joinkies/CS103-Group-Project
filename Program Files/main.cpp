/* CS103 Group Project - Jack & Jordan
* 
* Program allows users to make accounts, login, request rides and update;
*	payment details
* Drivers can make accounts, login, accept ride requests and log
*	their drives
* Admins can login, view the users and drivers in the data base
*	and check the total income generated by the drivers
*/

// Including all the necessary headers to get the program running.
#include <iostream>
#include <fstream>
#include <string>
#include <sstream>
...
// Including our namespaces, simplifying the programming workflow
using namespace std;
...
// Structure to hold the passengers credit card info - Jordan Code
struct cc {
	string card_no,
		card_xp,
		card_cvc;
...
// Driver struct holds all info of the logged in driver - Jordan Code
struct userDriver {
	int acc_no, trips;
	string f_name,
		l_name,
...
// Admin struct holds all the info of the logged in admin - Jordan Code
struct userAdmin {
	int id;
	string email;
	string password;
...
// Prototyping functions for my sanity's sake - Jordan Code
...
//base cost per kilometer - Jack Code
const int KILOMETER_RATE = 3;
const int TIME_RATE = 1;
const double GST = 0.15;

// Seperate menus for each type of user - Jack Coce
...
/*
* Defining vital global varaibles, for holding the info of the logged
* in driver of passenger- Jordan Code
*/
...
// The main loop of the program, everything starts and ends here - Jordan Code
int main() {
...
// Gets the number of users in temp file, when users are changing values in their account - Jordan Code
int getTempUsers() {
	ifstream countfile;
...
// help function for the first branch of the branch, main and login - Jordan Code
string help(int help_where) {
	switch (help_where) {
	case 1:
...
menu_restart:
	...
	while (loggedIn) {
		...
		cout << "\t2. Update Payment Details" << endl;
