...
/*
* This function is where the user decides if they are logging in our registering to the program.
*/
void logOrReg(loginType user_type) {
login_restart:
	string log_reg;
...
* to enter their email and password to log back and access the program
*/
bool login() {
	cout << "\nLogin\n\n";
...
* and all the neccessary information is collected and then written to the external file
*/
bool registration(loginType user_type) {
...
void updatePayment() {
	...
	case 'y':
		...
		cin >> currentPassenger.card_details.card_no;
		cout << "Enter card expiry: ";
		cin >> currentPassenger.card_details.card_xp;
		cout << "Enter card cvc: ";
		cin >> currentPassenger.card_details.card_cvc;
